...
//    }
    ...
    private void initComponents() {
        ...
        nameChar3.setForeground(new java.awt.Color(255, 51, 51));
        ...
        nameChar4.setForeground(new java.awt.Color(255, 255, 0));
        nameChar4.setText("SpacePenguin");
        getContentPane().add(nameChar4);
        nameChar4.setBounds(100, 680, 280, 40);

        nameChar5.setFont(new java.awt.Font("Chalkboard", 1, 36)); // NOI18N
        nameChar5.setForeground(new java.awt.Color(102, 102, 255));
        ...
        nameChar6.setForeground(new java.awt.Color(255, 0, 204));
...
//        this.monster.setImg(Character.getIcon());
//        this.monster.setImg(new javax.swing.ImageIcon(ImageResizer.resize("boardCyberKitty.jpg" ,300, 266)));        
